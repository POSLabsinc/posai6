...
const DeviceSetupHelpCard = ({ open, onClose, onSwitchToEmailPhone, onSwitchToBrowser, onSwitchToBrowserTab, onSwitchToDefaultView, onSwitchToOtp, initialStep = 0 }: Props) => {
  ...
  const steps: WalkthroughStep[] = [
    ...
    { id: "browser-steps", title: "Option 2: Use a Browser", subtitle: "Open the URL and enter the code", instructions: ["Open any web browser and go to the URL shown.", "When prompted, enter the activation code displayed on this screen."], tourTarget: "browser-steps", desktopCardPosition: "top", icon: <Link2 className="w-5 h-5" /> },
    { id: "code-input", title: "Option 3: Sign in with Code", subtitle: "Use email or phone number", instructions: ["Enter your registered email address or phone number.", "Tap 'Send Code' to receive a 6-digit verification code."], tourTarget: "email-input-field", desktopCardPosition: "top", icon: <Mail className="w-5 h-5" /> },
  ];
