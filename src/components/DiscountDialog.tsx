            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0 text-left">
                  <span className="text-[11px] font-medium text-white leading-tight">{discount.name}</span>
                  {reqReason && (
                    <span className="block text-[8px] font-medium mt-0.5 w-fit px-1 py-0.5 rounded" style={{ background: 'rgba(245,166,35,0.15)', color: '#f5a623' }}>
                      Reason required
                    </span>
                  )}
                </div>
