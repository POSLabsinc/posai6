...
const Header = () => {
  return (
    <header className="flex items-center justify-between px-4 py-2 bg-header text-header-foreground">
      {/* Left Section */}
      ...
      <div className="flex items-center gap-4">
        <button className="relative p-1 hover:bg-white/10 rounded transition-colors">
          ...
          <span className="absolute -top-1 -right-1 w-2.5 h-2.5 bg-green-500 rounded-full border border-header" />
        </button>
        ...
        <button className="p-1.5 bg-muted rounded-md hover:bg-muted/80 transition-colors">
