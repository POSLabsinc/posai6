...
export const InlineItemCustomization = ({
  ...
  const handlePriceClick = () => {
    // Don't allow price override for open price items (price is set via Open Price dialog)
      ...
      {activeTab === 'item' ? <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
          ...
          <div className="px-3 pb-2">
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1 flex items-center gap-2 bg-neutral-800 border border-neutral-600 rounded-full px-3 py-1.5">
                ...
                {addOnSearchQuery ? (
                  ...
                  <Mic className="w-3 h-3 text-neutral-400 flex-shrink-0" />
                )}
              </div>
              ...
              <div className="relative">
                <button 
                  ...
                  className="flex items-center justify-center bg-neutral-800 border border-neutral-600 rounded-full p-1.5 hover:bg-neutral-700 transition-colors"
                >
