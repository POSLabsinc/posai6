...
export const InlineItemCustomization = ({
  ...
  return (
    <div className="flex flex-col h-full bg-neutral-900 rounded-t-2xl">
      {/* Grabber Handle */}
        ...
        <div className="px-3 pb-2">
          <div className="flex flex-wrap gap-1">
            {selectedModifiers.map(modifier => (
              <span 
                key={modifier}
                className="px-2 py-0.5 bg-neutral-700 text-white text-[10px] rounded-full"
              >
                {modifier}
              </span>
            ))}
      ...
      <div className="px-3 pb-2">
        <div className="flex items-center gap-2 bg-neutral-800 rounded-lg px-2 py-1.5">
          ...
          <input
            ...
            className="flex-1 bg-transparent text-white text-xs placeholder:text-neutral-500 outline-none"
          />
        </div>
      </div>
      ...
      <div className="p-3 pt-2 flex items-center gap-2">
        <Button
          variant="outline"
          onClick={onCancel}
          className="px-4 py-2 rounded-full text-white font-medium text-xs bg-neutral-800 border-neutral-600 hover:bg-neutral-700"
        >
          CANCEL
        </Button>
        ...
        <Button
          ...
          style={{ background: 'linear-gradient(180deg, #C2C2C2 0%, #FFFFFF 100%)', color: 'black' }}
        >
