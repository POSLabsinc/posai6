      ...
      >
        ...
        <div className="w-[480px] flex flex-col bg-neutral-900 max-h-[90vh] overflow-hidden">
          {paymentProcessed ? (
            ...
            /* ============= DOORDASH FLOW - REPLACES ENTIRE PANEL ============= */
            <>
              {/* Header with Back Button */}
              <div className="flex items-center justify-between p-4 border-b border-neutral-700">
                <div className="flex items-center gap-3">
                ...
                <>
                  {textReceiptStep === 'receipt' && emailReceiptStep === 'receipt' ? (
                    <div className="flex-1 flex flex-col items-center justify-center px-6 py-6">
                      ...
                      <p className="text-neutral-400 text-sm mb-6">DoorDash Ref: {doordashReference}</p>
                    ...
                    <div className="flex flex-col flex-1">
                      ...
                      <div className="px-4 mb-4">
                        <button onClick={() => { setEmailReceiptStep('receipt'); setPaymentHistory(prev => [...prev, { method: 'doordash', amount: parseFloat(paymentAmount), methodLabel: 'DoorDash' }]); setDoordashStep('amount'); setDoordashReference(''); setPaymentProcessed(true); }} disabled={!emailReceiptEmail.includes('@')} className="w-full py-2.5 bg-neutral-600 text-neutral-300 font-semibold rounded-lg hover:bg-neutral-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm">SEND</button>
                      </div>
                    </div>
                  ) : null}
                </>
            ...
            /* ============= BLIZZFUL FLOW - REPLACES ENTIRE PANEL ============= */
            <>
              {/* Header with Back Button */}
              <div className="flex items-center justify-between p-4 border-b border-neutral-700">
                <div className="flex items-center gap-3">
                ...
                <>
                  {textReceiptStep === 'receipt' && emailReceiptStep === 'receipt' ? (
                    <div className="flex-1 flex flex-col items-center justify-center px-6 py-6">
                      ...
                      <p className="text-neutral-400 text-sm mb-6">Blizzful Ref: {blizzfulReference}</p>
            ...
            /* ============= UBEREATS FLOW - REPLACES ENTIRE PANEL ============= */
            <>
              {/* Header with Back Button */}
              <div className="flex items-center justify-between p-4 border-b border-neutral-700">
                <div className="flex items-center gap-3">
                ...
                <>
                  {textReceiptStep === 'receipt' && emailReceiptStep === 'receipt' ? (
                    <div className="flex-1 flex flex-col items-center justify-center px-6 py-6">
                      ...
                      <p className="text-neutral-400 text-sm mb-6">UberEats Ref: {ubereatsReference}</p>
            ...
            /* ============= GRUBHUB FLOW - REPLACES ENTIRE PANEL ============= */
            <>
              {/* Header with Back Button */}
              <div className="flex items-center justify-between p-4 border-b border-neutral-700">
                <div className="flex items-center gap-3">
                ...
                <>
                  {textReceiptStep === 'receipt' && emailReceiptStep === 'receipt' ? (
                    <div className="flex-1 flex flex-col items-center justify-center px-6 py-6">
                      ...
                      <p className="text-neutral-400 text-sm mb-6">Grubhub Ref: {grubhubReference}</p>
