...
export function PaymentDialog({
  ...
  const handleChargePayment = () => {
    ...
    // For Blizzful, go to reference step first
    if (selectedPaymentMethod === 'blizzful' && blizzfulStep === 'amount') {
      setBlizzfulStep('reference');
      return;
    }
    
    // For UberEats, go to reference step first
          ...
          {paymentProcessed ? (
            ...
            <>
              ...
              {selectedPaymentMethod === 'doordash' && doordashStep !== 'amount' ? (
                ...
                // Blizzful Step-by-Step Flow (separate screens)
                <>
                  {/* Header with Back Button */}
                  <div className="flex items-center justify-between p-4 border-b border-neutral-700">
                    <div className="flex items-center gap-3">
                    ...
                    <>
                      {textReceiptStep === 'receipt' && emailReceiptStep === 'receipt' ? (
                        <div className="flex-1 flex flex-col items-center justify-center px-6 py-6">
                          ...
                          <p className="text-neutral-400 text-xs mb-4">Blizzful Ref: {blizzfulReference}</p>
                        ...
                        /* Text Receipt Phone Input Screen for Blizzful */
                        <div className="flex flex-col flex-1">
                          <div className="px-4 pt-4 pb-2 text-center">
                            <h2 className="text-white text-base font-semibold">Where should we text your receipt?</h2>
                          </div>
                        ...
                        /* Email Receipt Input Screen for Blizzful */
                        <div className="flex flex-col flex-1">
                          <div className="px-4 pt-4 pb-2 text-center">
                            <h2 className="text-white text-base font-semibold">Where should we email your receipt?</h2>
                          </div>
                ...
                // UberEats Step-by-Step Flow (separate screens)
                <>
                  {/* Header with Back Button */}
                  <div className="flex items-center justify-between p-4 border-b border-neutral-700">
                    <div className="flex items-center gap-3">
                    ...
                    <>
                      {textReceiptStep === 'receipt' && emailReceiptStep === 'receipt' ? (
                        <div className="flex-1 flex flex-col items-center justify-center px-6 py-6">
                          ...
                          <p className="text-neutral-400 text-xs mb-4">UberEats Ref: {ubereatsReference}</p>
                        ...
                        /* Text Receipt Phone Input Screen for UberEats */
                        <div className="flex flex-col flex-1">
                          <div className="px-4 pt-4 pb-2 text-center">
                            <h2 className="text-white text-base font-semibold">Where should we text your receipt?</h2>
                          </div>
                        ...
                        /* Email Receipt Input Screen for UberEats */
                        <div className="flex flex-col flex-1">
                          <div className="px-4 pt-4 pb-2 text-center">
                            <h2 className="text-white text-base font-semibold">Where should we email your receipt?</h2>
                          </div>
                ...
                // Grubhub Step-by-Step Flow (separate screens)
                <>
                  {/* Header with Back Button */}
                  <div className="flex items-center justify-between p-4 border-b border-neutral-700">
                    <div className="flex items-center gap-3">
                    ...
                    <>
                      {textReceiptStep === 'receipt' && emailReceiptStep === 'receipt' ? (
                        <div className="flex-1 flex flex-col items-center justify-center px-6 py-6">
                          ...
                          <p className="text-neutral-400 text-xs mb-4">Grubhub Ref: {grubhubReference}</p>
                        ...
                        /* Text Receipt Phone Input Screen for Grubhub */
                        <div className="flex flex-col flex-1">
                          <div className="px-4 pt-4 pb-2 text-center">
                            <h2 className="text-white text-base font-semibold">Where should we text your receipt?</h2>
                          </div>
                        ...
                        /* Email Receipt Input Screen for Grubhub */
                        <div className="flex flex-col flex-1">
                          <div className="px-4 pt-4 pb-2 text-center">
                            <h2 className="text-white text-base font-semibold">Where should we email your receipt?</h2>
                          </div>
                          ...
                          <div className="px-4 mb-4">
                            <button onClick={() => { setEmailReceiptStep('receipt'); setPaymentHistory(prev => [...prev, { method: 'grubhub', amount: parseFloat(paymentAmount), methodLabel: 'Grubhub' }]); setGrubhubStep('amount'); setGrubhubReference(''); setPaymentProcessed(true); }} disabled={!emailReceiptEmail.includes('@')} className="w-full py-2.5 bg-neutral-600 text-neutral-300 font-semibold rounded-lg hover:bg-neutral-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm">SEND</button>
                          </div>
                        </div>
                      ) : null}
                    </>
