  ...
  return (
    <div className="h-full w-full flex flex-col bg-background overflow-hidden">
      ...
      <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-3 gap-4 p-4 lg:p-6 overflow-hidden">
        ...
        {/* RIGHT: AI panel */}
        <div className="hidden lg:flex flex-col min-h-0 rounded-2xl overflow-hidden" style={cardStyle}>
          <div className="flex items-center gap-2 px-4 py-3 border-b border-white/5 shrink-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] text-muted-foreground/70">Answers based on visible data</p>
            </div>
          </div>
