    ...
    return (
      <div className="min-h-screen bg-background flex flex-col">
        <div className="flex items-center justify-between px-4 py-3 overflow-visible shrink-0">
          <button
            onClick={() => navigate('/settings/notifications/all')}
        ...
        <div className="flex-1 overflow-hidden">
          <NotificationDetailContent
            showHeader={false}
            onBack={() => navigate('/settings/notifications/all')}
          />
        </div>
        <BottomNavigation />
      </div>
...
export default NotificationDetailRoute;
