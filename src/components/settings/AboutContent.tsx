  ...
  return (
    <div className="h-full overflow-y-auto scrollbar-hide overscroll-contain">
      ...
      <div className="px-6 pb-28">
        ...
        {/* SOFTWARE Section */}
        <p className="text-base font-medium text-muted-foreground mb-0.5 px-1">Software</p>
        ...
        <p className="text-base font-medium text-muted-foreground mb-0.5 px-1">Terms & Policy</p>
