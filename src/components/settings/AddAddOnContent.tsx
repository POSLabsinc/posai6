...
interface AddAddOnContentProps {
  onBack: () => void;
  onSave: (data: {
    name: string;
    ...
    <div className="h-full flex flex-col overflow-hidden bg-background">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide pt-6 px-6 pb-28">
        ...
        <p className="text-neutral-500 text-sm px-1 mt-1.5 mb-6">
          Choose which order types this add-on applies to, such as Dine-In, Takeaway, or Delivery. This allows you to control where the add-on can be offered.
        </p>
        ...
        <div className="mb-1">
          ...
          <div className="bg-neutral-800/60 rounded-2xl overflow-hidden">
            ...
            <div className="flex items-center justify-between py-3.5 px-4 border-b border-neutral-700/50">
              <span className="text-foreground text-[15px]">Add-On Name</span>
              <Input
                value={name}
            ...
            <div className="flex items-center justify-between py-3.5 px-4 border-b border-neutral-700/50">
              ...
              <Switch checked={canBeServed} onCheckedChange={setCanBeServed} />
            </div>

            {/* Mark as Unavailable (86) */}
            <div className="flex items-center justify-between py-3.5 px-4 border-b border-neutral-700/50">
              <span className="text-foreground text-[15px]">Mark as Unavailable (86)</span>
              <Switch checked={is86} onCheckedChange={setIs86} />
            </div>
            ...
            {/* Inline Options (shown when hasOptions is true) */}
            {hasOptions && (
              <>
        ...
        <p className="text-neutral-500 text-sm px-1 mt-1.5 mb-6">
          Enable this if the add-on includes multiple choices. For example, Drink Upgrade (Coke, Sprite, Fanta) or Side Choice (Fries, Salad, Rice).
        </p>
      </div>
    </div>
  );
...
export default AddAddOnContent;
