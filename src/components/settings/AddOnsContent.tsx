        ...
        <div className="flex-1 overflow-y-auto scrollbar-hide px-6 pb-6">
          ...
          <section className="mt-4 rounded-[28px] bg-[#26262699] px-10 py-8 text-center">
            <div 
              ...
              style={{ backgroundColor: getIconBgColor("#FF6381") }}
            >
              <img src={addonsIcon} alt="Add-Ons" className="h-8 w-8 object-contain" />
            </div>
            <h1 className="text-2xl font-semibold leading-tight text-foreground">Add-Ons</h1>
            <p className="mx-auto mt-2 max-w-3xl text-[15px] leading-relaxed text-[hsl(var(--text-subtle))]">
              Explore a culinary revolution with food add-ons – from truffle-infused salts to exotic spice blends, transforming ordinary dishes into extraordinary experiences.
            </p>
          </section>
      ...
      {showHeader && (
        <div className="flex items-center justify-center py-4 px-4 relative">
          ...
          <div className="flex items-center gap-1">
            <h1 className="text-lg font-semibold text-foreground">Add-Ons</h1>
            <button
              onClick={() => {
                toast({
