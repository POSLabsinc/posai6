      ...
      <div className="h-full flex flex-col overflow-hidden bg-background">
        ...
        <div className="flex-1 overflow-y-auto scrollbar-hide px-6 pb-6">
          ...
          <section className="mt-6 flex items-center gap-2 lg:gap-4">
            ...
            <button onClick={() => navigate('/settings/menu/default-modifiers/add')} className="h-12 rounded-full px-5 lg:px-10 flex-shrink-0 flex items-center justify-center gap-2 bg-neutral-800/60 text-foreground active:opacity-70 transition-opacity">
    ...
    <div className="h-full flex flex-col overflow-hidden bg-background">
      {showHeader && (
        <div className="flex items-center justify-center py-4 px-4 relative">
          ...
          <div className="flex items-center gap-1">
            <h1 className="text-xl font-semibold text-foreground">Default Modifiers</h1>
            <button onClick={() => { toast({ description: "Set up modifiers that are automatically applied to products by default.", duration: 4000 }); }} className="active:opacity-70 transition-opacity">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide px-4 pb-4">
        <div className="flex gap-3 mb-4">
          ...
          <button onClick={() => navigate('/settings/menu/default-modifiers/add')} className="flex-1 py-4 bg-neutral-800 rounded-full flex items-center justify-center gap-2 active:opacity-70 transition-opacity">
