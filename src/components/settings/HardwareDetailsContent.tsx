    ...
    <div className="h-full overflow-y-auto scrollbar-hide overscroll-contain">
      {showHeader && (
        <div className="flex items-center justify-between pt-0 pb-2 relative overflow-visible px-4">
          ...
          <h1 className="text-xl font-semibold text-foreground absolute left-1/2 -translate-x-1/2">Hardware</h1>
        </div>
      )}
      ...
      <div className={`px-4 md:px-6 pb-28`}>
        ...
        <div className="bg-neutral-800/60 rounded-2xl overflow-hidden mb-4 px-4 py-3.5">
          <label className="text-sm text-muted-foreground mb-1 block">Point of Sale Terminal Name</label>
          <input
            type="text"
            value={terminalName}
            onChange={(e) => handleTerminalNameChange(e.target.value)}
            placeholder="e.g. Point of Sale 1, Bar Terminal, Drive-Thru"
