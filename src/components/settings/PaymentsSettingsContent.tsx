  ...
  return <div className="h-full overflow-y-auto scrollbar-hide overscroll-contain">
      ...
      <div className={`${showHeader ? 'pt-0' : 'pt-0'} px-4 md:px-6 pb-28`}>
        ...
        <div className="space-y-4">
          ...
          <SettingsOption icon={receiptIcon} iconBgColor="#8E8E93" label="Receipts" description="Choose layout styles, fonts, and logo settings for KOT, payment, and guest receipts across print, email, and SMS." onClick={() => onNavigate?.('/settings/payments/receipts')} />
