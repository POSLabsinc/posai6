    ...
    <div className="h-full overflow-y-auto scrollbar-hide overscroll-contain">
      {showHeader && (
        <div className="flex items-center justify-center py-4 border-b border-neutral-800/50 relative">
          ...
          <h1 className="text-base font-medium text-foreground">Server Connection</h1>
        </div>
      )}
      ...
      <div className="pt-6 px-6 pb-28">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-medium text-neutral-500 tracking-wider uppercase">Cloud Server</span>
            <Switch
          ...
          {cloudServerEnabled && (
            <div className="bg-neutral-800/60 rounded-2xl overflow-hidden">
              ...
              <div className="flex items-center justify-between py-3.5 px-4">
                ...
                <span className="text-neutral-400 text-base">rohan POS</span>
              </div>
        ...
        {cloudServerEnabled && (
          <>
            <div className="flex gap-3 mb-4">
              <button className="flex-1 bg-neutral-800 hover:bg-neutral-700 text-foreground font-semibold py-3.5 rounded-2xl text-sm tracking-wide uppercase transition-colors text-center">
                Manual Sync
                <span className="block text-[10px] font-normal text-neutral-400 tracking-wider mt-0.5 uppercase">Cloud Server</span>
              </button>
              <button className="flex-1 bg-transparent border border-neutral-700 hover:bg-neutral-800/50 text-foreground font-semibold py-3.5 rounded-2xl text-sm tracking-wide uppercase transition-colors text-center">
                Force Sync
                <span className="block text-[10px] font-normal text-neutral-400 tracking-wider mt-0.5 uppercase">Cloud Server</span>
              </button>
            </div>
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-medium text-neutral-500 tracking-wider uppercase">edgeOS + Cloud Server</span>
            <Switch
