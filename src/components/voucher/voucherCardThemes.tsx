...
export const CARD_THEMES: CardTheme[] = [
  // Elegant: dark + gold
  {
    ...
    glow: 'border-amber-500/6   subtitle: 'text-amber-500/70',
    pattern: (
      <>
  ...
  // Modern: gradient + bold
  {
    ...
    badgeBg: 'bg-blue-500/15 border-blue-500/30border-blue-400/6ia-cyan-200 to-blue-300 bg-clip-text text-transpborder-blue-400/6assName="absolute top-0 left-0 w-full h-full opaborder-blue-400/6rent, transparent 20px, rgba(96,165,250,0.3) 20px, rgba(96,165,250,0.3) 21px)' }} />
  ...
  // Festive: warm accent
  {
    ...
    valueBg: 'bg-gradient-to-r from-rose-300 via-pink-200 to-rose-300 bg-clip-text text-transborder-rose-400/6assName="absolute top-0 right-0 w-full h-full opacity-[0.03]" style={{ backgroundImage: 'radial-gradient(circle border-rose-400/620% 80%, rgba(244,114,182,0.3) 0%, transparent 50%)' }} />
  ...
  // Emerald luxury
  {
    ...
    pattern: (
      <>
        <div className="absolute botborder-emerald-400/6 80% 80%, #34d399 0%, transparent 60%)' }} />
  ...
  // Violet premium
  {
    ...
    valueBg: 'bg-border-violet-400/6nt',
