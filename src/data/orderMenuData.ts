...
export type SubcategoryItems = Record<string, MenuItem[]>;
export type CategoryItems = Record<string, SubcategoryItems>;
export type MenuItemsStructure = Record<string, CategoryItems>;

export const menuItemsData: MenuItemsStructure = {
  "BAKERY MENU": {
    "Breads": {
      "Sourdough": [{
        id: 0,
...
export const getCategoryHoverBgColor = (category: string) => {
...
export const getCategoryHoverTextColor = (category: string) => {
