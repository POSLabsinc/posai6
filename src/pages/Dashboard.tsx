      ...
      {showPaymentDialog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="mx-4 animate-scale-in">
            {/* Combined Payment & Order Panel */}
            <div className="bg-neutral-900 rounded-xl border border-neutral-700 w-[420px] overflow-hidden flex flex-col max-h-[90vh]">
              {/* Guest Info Header */}
              <div className="p-3 border-b border-neutral-700">
                ...
                <div className="flex items-center gap-4 mt-2 text-xs">
                  ...
                  <span className="text-neutral-400 ml-auto">Check {selectedOrder?.check || "62"}</span>
                </div>
              </div>

              {/* Order Items */}
              <div className="flex-1 overflow-y-auto p-3 space-y-1 max-h-[200px]" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                {orderItems.map((item) => (
                  <div key={item.id} className="flex items-start justify-between py-1.5 border-b border-neutral-700/50 last:border-0">
              ...
              {/* Order Summary */}
              <div className="px-3 py-2 border-t border-neutral-700 space-y-1">
              ...
              <div className="px-3 pb-2">
                <div className="flex items-center gap-2 bg-neutral-800 rounded-lg px-3 py-2">
                  <span className="flex-1 text-white text-base font-medium">${paymentAmount}</span>
                  <button className="w-7 h-7 rounded bg-neutral-700 flex items-center justify-center hover:bg-neutral-600 transition-colors">
              ...
              <div className="p-3 border-t border-neutral-700">
                <button
                  onClick={() => setShowPaymentDialog(false)}
                  className="w-full py-2.5 bg-neutral-800 hover:bg-neutral-700 text-white font-bold rounded-lg transition-colors text-sm"
                >
