  ...
  return (
    <div className="flex gap-4 overflow-hidden bg-neutral-950 gradient-mesh p-4" style={{ height: 'calc(100vh - 60px)' }}>
      ...
      <div className="flex-1 flex flex-col gap-0 min-w-0 overflow-hidden glass-dark rounded-2xl">
        {/* ROW 1: Large Glass Segment Control for Categories */}
        <div className="flex-shrink-0 p-4 border-b border-white/10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-white/40 text-sm">Liquid Glass 3A: Two-Tier Glass Tabs</span>
          </div>
          
          {/* Main Category Segment */}
          <div className="glass-vibrant rounded-2xl p-2 flex gap-2 overflow-x-auto scrollbar-hide">
        ...
        {/* ROW 2: Smaller Glass Pills for Subcategories */}
        <div className="flex-shrink-0 p-4 border-b border-white/10">
          {/* Gradient Line Divider */}
          <div className="h-px bg-gradient-to-r from-transparent via-orange-500/50 to-transparent mb-4" />
          ...
          <div className="flex gap-2 overflow-x-auto scrollbar-hide">
            {(categorySubcategories[activeCategory] || []).map((sub, index) => (
              <button
                ...
                className={`px-5 py-2.5 rounded-full text-sm font-medium whitespace-nowrap transition-all duration-300 animate-scale-in ${
        ...
        <div className="px-4 py-3 flex-shrink-0">
          <p className="text-sm text-white/50">
            ...
            <span className="text-amber-400">{activeSubcategory}</span>
          </p>
        </div>
      ...
      {/* Right Panel - Slide-out Drawer Style */}
...
export default LiquidGlassOrders3A;