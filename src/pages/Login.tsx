              ...
              >
                <div className="relative">
                  {activationContactValue.includes("@") ? (
                    <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-foreground/30" />
                  ) : /^\d|^\(/.test(activationContactValue) && !activationContactValue.includes("@") && activationContactValue.replace(/\D/g, '').length > 0 ? (
      ...
      return (
        <DeviceSetupLayout variant="activation">
          ...
          >
            ...
            >
              <div className="relative">
                {magicLinkEmail.includes("@") || (!magicLinkPhone && !(/^\d|^\(/.test(magicLinkEmail))) ? (
                  <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-foreground/30" />
                ) : (
                  <Phone className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-foreground/30" />
                )}
