      ...
      <div className="fixed inset-0 login-bg flex flex-col items-center justify-center overflow-auto">
        ...
        <div className="relative z-10 w-full max-w-5xl px-4 sm:px-6 md:px-8 py-6 sm:py-8 flex flex-col items-center">
          ...
          <div className="md:hidden w-full">
            ...
            >
              <p className="text-xs font-medium text-foreground/40 mb-1.5 uppercase tracking-wider">Option 1</p>
              <h2 className="text-base font-bold text-foreground mb-4 text-center">Point the camera at the QR code</h2>
              <button
                onClick={() => {
                  setShowDeviceConnected(true);
                  setDeviceName("Rustic Table POS 1");
                ...
                className="bg-foreground rounded-2xl p-3 flex-shrink-0 cursor-pointer hover:opacity-90 transition-opacity mb-3"
              >
                <QRCodeSVG value={activationQrValue} size={140} bgColor="hsl(0 0% 100%)" fgColor="hsl(0 0% 0%)" level="M" />
              </button>
            ...
            <div className="flex gap-2 mb-4">
              <button
                onClick={() => setMobileActivationTab(mobileActivationTab === "browser" ? null : "browser")}
                className={`flex-1 py-3 px-3 rounded-xl text-sm font-medium transition-all border ${
                  mobileActivationTab === "browser"
                    ? "bg-foreground/[0.1] border-foreground/[0.15] text-foreground"
                    : "bg-foreground/[0.04] border-foreground/[0.08] text-foreground/50"
                }`}
              >
              ...
              <button
                onClick={() => setMobileActivationTab(mobileActivationTab === "email" ? null : "email")}
                className={`flex-1 py-3 px-3 rounded-xl text-sm font-medium transition-all border ${
                  mobileActivationTab === "email"
                    ? "bg-foreground/[0.1] border-foreground/[0.15] text-foreground"
                    : "bg-foreground/[0.04] border-foreground/[0.08] text-foreground/50"
                }`}
              >
            ...
            <AnimatePresence mode="wait">
              {mobileActivationTab === "browser" && (
                ...
                >
                  <div className="p-4 rounded-2xl bg-foreground/[0.03] border border-foreground/[0.06] space-y-5">
