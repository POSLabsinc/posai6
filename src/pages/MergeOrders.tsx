  ...
  const DesktopCurrentOrderCard = ({ order }: { order: typeof allOrders[0] }) => (
    ...
    >
      <div className="flex items-stretch w-full">
        ...
        {/* Column 3: Timer & Server - Tablet/Desktop only */}
        <div className="hidden md:block w-[12%] flex-shrink-0 py-2">
        ...
        {/* Column 4: Check & Revenue Center - Tablet/Desktop only */}
        <div className="hidden md:block w-[12%] flex-shrink-0 py-2">
          <div className="flex flex-col text-xs gap-1">
            <div className="text-left">
        ...
        {/* Column 5: Payment Type - Tablet/Desktop only */}
        <div className="hidden md:block w-[12%] flex-shrink-0 self-start py-2">
