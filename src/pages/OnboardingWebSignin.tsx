...
const OnboardingWebSignin = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (ok) {
        navigate("/onboarding/web/signin/success", { state: { source: "web" } });
      } else {
  ...
  const footerText = (
    <p className="text-xs text-foreground/50 text-center">
      ...
      <button
        onClick={() => navigate("/onboarding/app/signup/account?source=web")}
...
export default OnboardingWebSignin;
