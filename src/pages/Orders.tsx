...
const Orders = () => {
  ...
  return <div className="flex flex-col md:flex-row gap-[10px] md:gap-3 lg:gap-4 h-full overflow-hidden">
      ...
      marginTop: 'auto'
        ...
        <div 
          className="flex items-center justify-between px-3 py-1.5 cursor-grab active:cursor-grabbing select-none md:hidden bg-neutral-900 rounded-t-[20px] touch-none"
