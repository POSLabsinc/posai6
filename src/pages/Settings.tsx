...
const getContentForRoute = (
  ...
  if (showAIChat) {
    return <AISettingsContent showHeader={true} onBack={() => setShowAIChat(false)} />;
  }
  ...
  if (pathname === '/settings/system/fonts') {
    return <FontsContent showHeader={true} onBack={() => navigate('/settings/system/appearance')} onAIClick={() => setShowAIChat(true)} />;
  }
  ...
  if (pathname === '/settings/menu') {
    return <MenuSettingsContent showHeader={true} onBack={() => navigate('/settings')} onNavigate={navigate} onAIClick={() => setShowAIChat(true)} />;
  }
  ...
  if (pathname === '/settings/menu/products') {
    return <ProductsContent showHeader={true} onBack={() => navigate('/settings/menu')} onAIClick={() => setShowAIChat(true)} />;
  }
  ...
  if (pathname.startsWith('/settings/menu/default-modifiers/edit/')) {
    return <EditDefaultModifierContent showHeader={true} onBack={() => navigate('/settings/menu/default-modifiers')} />;
  }
  ...
  if (pathname.startsWith('/settings/menu/groups/edit/')) {
    return <EditGroupContent showHeader={true} onBack={() => navigate('/settings/menu/groups')} />;
  }
  ...
  if (pathname === '/settings/reports') {
    return <ReportsContent showHeader={true} onBack={() => navigate('/settings')} onAIClick={() => setShowAIChat(true)} />;
  }
  if (pathname === '/settings/end-of-day') {
    return <EndOfDayContent showHeader={true} onBack={() => navigate('/settings')} onAIClick={() => setShowAIChat(true)} />;
  }
  if (pathname === '/settings/guest-book') {
    return <GuestBookContent showHeader={true} onBack={() => navigate('/settings/account')} onAIClick={() => setShowAIChat(true)} />;
  }
...
const Settings = () => {
  ...
  // Guest Book: full-screen mode, hide sidebar
  if (!isMobile && isGuestBook) {
    return (
      <div className="h-full flex p-0 md:p-2 overflow-hidden">
