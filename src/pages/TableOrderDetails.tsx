...
const TableOrderDetails = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case "ORDERING": return "text-yellow-400";
  ...
  return (
    <div className="flex h-full bg-black">
      ...
      <div 
        className="flex flex-col flex-1 m-2 rounded-[20px] overflow-hidden"
        style={{ 
          background: "#7575754D",
              ...
              >
                <div className="flex items-center w-full gap-4">
                  ...
                  <div className="w-[8%] flex-shrink-0">
                    <div className="relative w-12 h-14 bg-neutral-800 rounded-lg flex flex-col items-center justify-center gap-1 border border-neutral-600">
                      <span className="text-lg font-bold text-white">{guest.id}</span>
                      <img src={tableTargetIcon} alt="Table" className="w-5 h-5" />
                    </div>
                  </div>
      ...
      <div 
        className="w-[345px] flex flex-col m-2 ml-0 rounded-[20px] overflow-hidden"
        style={{ 
          background: "#7575754D",
          boxShadow: "inset 4px 4px 24px 0px rgba(255, 255, 255, 0.15)"
        }}
        ...
        <ScrollArea className="flex-1 p-3">
          <div className="space-y-2">
            {orderItems.map((item, index) => (
              <div key={index} className="p-3 bg-neutral-900/50 rounded-xl border border-neutral-700">
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      {item.modifiers.length > 0 && (
                        <div className="mt-1 text-gray-400 text-sm space-y-0.5">
                ...
                {item.seats.length > 0 && (
                  <div className="flex items-center gap-1 mt-2">
                    ...
                    {item.seats.map((seat) => (
                      <span key={seat} className="w-5 h-5 bg-neutral-700 rounded text-white text-xs flex items-center justify-center">
                        {seat}
                      </span>
                    ))}
                  </div>
